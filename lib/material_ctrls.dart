...
import 'package:lc_video_player/central_control.dart';
import 'package:lc_video_player/main.dart';
import 'package:provider/provider.dart';
import 'package:video_player/video_player.dart';

class MaterialDesktopControlsAlt extends StatefulWidget {
  const MaterialDesktopControlsAlt({
  ...
  State<StatefulWidget> createState() {
    return _MaterialDesktopControlsAltState();
  }
}

class _MaterialDesktopControlsAltState extends State<MaterialDesktopControlsAlt>
  ...
  SystemMouseCursor cursor =
      SystemMouseCursors.zoomIn; //Large mouse because why not
    ...
    return Row(
      ...
      children: [
        GestureDetector(
          ...
          child: CenterControlButton(
            icon: Icon(
              Icons.replay_10_outlined,
              color: Colors.white,
              size: MediaQuery.sizeOf(context).longestSide * 0.05,
            ),
